...
class HudFrameWorkTests(unittest.TestCase):
    ...
    def test_stopwatch_draw_path_keeps_smooth_values_without_ui_commands(self):
        ...
        # Shutdown runs inside connect and demo, which read Cmd_Argv afterwards,
        # so executing a command there would overwrite their arguments.
        self.assertNotIn("Stopwatch", shutdown)
        self.assertNotIn("Cmd_Execute", shutdown)
