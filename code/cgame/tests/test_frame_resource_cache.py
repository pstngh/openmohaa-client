...
LOCAL = (CGAME / "cg_local.h").read_text()
...
class FrameResourceCacheTests(unittest.TestCase):
    def test_configstring_image_shaders_are_lazy_and_invalidated(self):
        ...
        self.assertIn("return 0;", lookup)
        self.assertNotIn("cgi.Error", lookup)
    ...
    def test_hud_shaders_follow_lazy_or_cvar_aware_cache_paths(self):
        ...
        self.assertIn("instantMessageShaders[7]", LOCAL)
        self.assertIn("ARRAY_LEN(cgs.media.instantMessageShaders)", instant_message)
