...
{
    // Don't execute console commands here: this runs inside commands such as
    // connect and demo, which read their arguments afterwards. The next cgame
    // clears any stopwatch HUD left behind on its first frame.
