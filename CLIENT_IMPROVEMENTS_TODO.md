...
- [x] `4b387dab` - make stopwatch HUD transitions event-driven and cache objective configstrings.
- [x] `ad26889b` - cache frame-path render resources.
- [x] `104a28b8` - make scoreboard and countdown work change-driven.
- [x] `bdb0e821` - streamline packet-entity traversal and remove discarded renderer lookups.
