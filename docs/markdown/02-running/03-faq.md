...
[^1]: `omconfig.cfg` is the OpenMoHAA configuration file. By default, it is in the game's installation folder under `main/configs/`, `mainta/configs/`, or `maintt/configs/`, depending on the selected game.
